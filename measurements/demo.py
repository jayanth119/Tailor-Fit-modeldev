...
DATA_DIR = r"C:\Users\Sai\Desktop\My\dream\projects\Tailor-Fit-modeldev\outputs"
...
def convert_cp():
  ...
  f = open(os.path.join(DATA_DIR, r'C:\Users\Sai\Desktop\My\dream\projects\Tailor-Fit-modeldev\references\customBodyPoints.txt'), "r")
...
#    vertex = obj2npy(gender)[0]
    ...
    face_path = r'C:\Users\Sai\Desktop\My\dream\projects\Tailor-Fit-modeldev\measurements\smpl_faces.npy'
    faces = np.load(face_path)
    obj_mesh_name = r'C:\Users\Sai\Desktop\My\dream\projects\Tailor-Fit-modeldev\outputs\result_poojitha_256.obj'
